    ...
    <>
      {isLoading || isFetching ? (
        ...
        <div className="flex h-[35vw] flex-col rounded-xl p-4 py-4 sm:p-8">
          <span>
            An error occurred while loading the metadata for this collection.
            Please try again later. You may take reference of this error message
            first.
          </span>
        ...
        <div key="details" className="flex flex-col">
