...
>(({ side = "right", className, children, ...props }, ref) => (
  <SheetPortal>
    ...
    >
      {children}
      <SheetPrimitive.Close className="group absolute right-4 top-4 rounded-sm opacity-70 transition-opacity hover:opacity-100 focus:outline-none disabled:pointer-events-none data-[state=open]:bg-secondary">
        <div className="rounded-md border-slate-900 p-2 duration-300 group-hover:-translate-x-[2px] group-hover:-translate-y-[2px] group-hover:border-2 group-hover:border-b-4 group-hover:border-r-4 group-hover:bg-blue-700">
          <X className="h-6 w-6 group-hover:text-slate-100" />
